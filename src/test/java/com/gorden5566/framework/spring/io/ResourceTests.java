package com.gorden5566.framework.spring.io;
...
public class ResourceTests {
    ...
    /**
     * 使用InputStream构造InputStreamResource
     *
     * @throws IOException
     */
    @Test
    ...
    public void testFileSystemResourceWithFilePath() throws Exception {
        File filePath = Paths.get(getClass().getResource("Resource.class").toURI()).toFile();
